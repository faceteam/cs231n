...
dir = 'G:/homework/assignment1/cs231n/datasets/cifar-10-batches-py'
...
for k in k_choices:
    ...
    for i in range(num_folds):
        Xtr=np.vstack(X_train_folds[:i]+X_train_folds[i+1:])
        ...
        #yte_pred=np.reshape(yte_pred,(yte.shape[0],-1))
